...
export default function TradeApp() {
    return (
        <body className="bg-[#080023]">
            ...
            <div className="ml-12">
                <Card className="bg-[#080023] border border-[#8D8D8D] lg:md:w-1/4 overflow-hidden">
                        ...
                        <TabsContent value="market">
                            <div className="my-6">
                                <div className="grid grid-cols-2 gap-1 mx-4 mb-6 bg-gray-900 rounded-lg p-1">
                                    <button className="py-2 rounded-lg bg-[#1B2F42] text-white font-semibold">Buy</button>
                                    <button className="py-2 rounded-lg text-gray-400 font-semibold">Sell</button>
                                </div>

                                <CardContent className="space-y-4">
                                    <div className="space-y-2">
                                        <Label htmlFor="name" className="text-white text-lg">Price</Label>
                                        <Input id="name" defaultValue="" placeholder="Market Price" className="bg-[#080023] border border-[#8D8D8D] text-white placeholder:text-lg placeholder:text-white" />
                                    </div>

                                    <div className="space-y-2">
                                        <Label htmlFor="name" className="text-white text-lg">Amount</Label>
                                        <Input id="name" defaultValue="" placeholder="0                                                                        BTC" className="bg-[#080023] border border-white text-white placeholder:text-lg placeholder:text-white" />
                                    </div>
